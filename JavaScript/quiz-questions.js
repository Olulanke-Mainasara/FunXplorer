...
export const questions = {
  Biology: [
    ...
    {
      question: "What is the term for the genetic material in a cell?",
      options: ["RNA", "DNA", "Protein", "Chromosome"],
      answerIndex: 1,
    },
    {
    ...
    {
      question:
        "What is the process by which plants lose water through leaves?",
    ...
    {
      question:
        "What is the term for a group of similar cells performing a function?",
  ...
  Physics: [
    ...
    {
      question:
        "What is the phenomenon of splitting light into its colors called?",
      options: ["Reflection", "Refraction", "Dispersion", "Diffraction"],
      answerIndex: 2,
    },
    {
      question:
        "What is the measure of the resistance of a material to the flow of electric current?",
    ...
    {
      question:
        "What is the term for the energy possessed by a body due to its motion?",
      options: [
        "Potential energy",
        "Kinetic energy",
        "Thermal energy",
    ...
    {
      question:
        "What is the term for the force that opposes the motion of objects through air?",
    ...
    {
      question:
        "What is the term for the product of mass and velocity of an object?",
      options: ["Force", "Momentum", "Energy", "Acceleration"],
      answerIndex: 1,
    },
    {
      question:
        "What is the term for the transfer of heat through a solid material?",
      options: ["Conduction", "Convection", "Radiation", "Evaporation"],
      answerIndex: 0,
    },
    {
      question:
        "What is the term for the distance traveled by light in one year?",
      options: ["Light second", "Light minute", "Light year", "Light hour"],
      answerIndex: 2,
    },
    {
      question:
        "What is the term for the force that acts between two charged objects?",
      options: [
        "Gravitational force",
        "Magnetic force",
        "Electric force",
  ...
  Math: [
    ...
    {
      question: "What is the median of the numbers 3, 7, 9, 15, and 21?",
      options: ["7", "9", "15", "21"],
      answerIndex: 1,
    },
  ],
  ...
  English: [
    ...
    },
    {
      ...
      options: ["Quick", "Run", "Table", "Happily"],
      answerIndex: 0,
    },
    {
    ...
    },
    {
      ...
      options: ["Jump", "Beautiful", "Quickly", "Table"],
      answerIndex: 0,
    },
    {
    ...
    },
    {
      ...
      options: ["Happier", "Happiest", "Most happy", "Happily"],
      answerIndex: 1,
    },
    {
      question: "Which of these is a preposition?",
      options: ["Under", "Run", "Quick", "Table"],
      answerIndex: 0,
    },
    {
